...
export declare class Registry {
    ...
    stepDefinitions: IStepDefinition<unknown[]>[];
    beforeHooks: IHook[];
    afterHooks: IHook[];
    ...
    getMatchingStepDefinitions(text: string): IStepDefinition<unknown[]>[];
    resolveStepDefintion(text: string): IStepDefinition<unknown[]>;
